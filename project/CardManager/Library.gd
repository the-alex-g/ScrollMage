...
var attacks := {
	#"":{"text":"", "casting_time":0.0, "flags":[], "statuses":{}, "damage":0, "projectile_path":""},
...
func get_attack(card_name := "")->AttackCard:
	...
	return AttackCard.new(card_name, card_info.text, card_info.casting_time, card_info.flags, card_info.statuses, card_info.damage, card_info.projectile_path)
...
func get_ritual(card_name := "")->RitualCard:
	...
	return RitualCard.new(card_name, card_info.text, card_info.casting_time, card_info.flags, card_info.statuses, card_info.duration)
